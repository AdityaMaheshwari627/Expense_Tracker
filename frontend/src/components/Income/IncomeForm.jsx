    ...
    >
      ...
      >
        <input
          ...
          ${
            darkMode
              ...
              : "bg-white border-gray-300 text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-teal-500"
          }`}
        />
        ...
        <input
          ...
          ${
            darkMode
              ? "bg-[#1E293B] border-gray-700 text-white focus:ring-2 focus:ring-teal-500"
        ...
        <div className="md:col-span-2 flex gap-4">
          <button
            type="submit"
            disabled={loading}
            className="flex-1 bg-teal-600 hover:bg-teal-700 text-white py-3 rounded-xl font-semibold transition disabled:opacity-60"
          >
            {loading
              ? "Saving..."
              : isEditing
